...
const DasboardAdmin = () => {
  ...
  const prepareChartData = () => {
    ...
    const labels = chartData.map(
      (item) => `Minggu ke-${item.week}, ${item.month}/${item.year}`,
    );
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Dashboard title="Dashboard">
        <div className="flex flex-col flex-1 mx-auto max-w-7xl xl:flex-row lg:w-full">
          <div className="grid flex-1 w-full h-full grid-cols-12 gap-4 xl:w-full xl:px-5">
            <div className="relative col-span-12 overflow-hidden transition-all duration-300 ease-in-out transform bg-white rounded-lg shadow-md cursor-pointer md:col-span-3 group hover:shadow-lg active:shadow-md hover:-translate-y-1">
              <span className="absolute flex w-6 h-6 -right-2 -top-2">
                <span className="absolute inline-flex w-full h-full rounded-full opacity-75 group-hover:animate-ping bg-maroon"></span>
                <span className="relative inline-flex w-6 h-6 rounded-full bg-maroon"></span>
              </span>
              <div className="p-4">
                ...
                <div className="flex items-center justify-center p-4">
                  <h2 className="mt-4 text-5xl font-extrabold text-gray-600">
                    {countOnlineUser.online_users}
                  </h2>
                </div>
              </div>
            </div>
            <div className="relative col-span-12 overflow-hidden transition-all duration-300 ease-in-out transform bg-white rounded-lg shadow-md cursor-pointer md:col-span-9 group hover:shadow-lg active:shadow-md hover:-translate-y-1">
              <div className="p-4">
            ...
            <div className="relative col-span-12 mt-4 overflow-hidden transition-all duration-300 ease-in-out transform bg-white rounded-lg shadow-md md:col-span-6 group hover:shadow-lg active:shadow-md hover:-translate-y-1">
              <div className="flex flex-col h-full p-4">
                <div className="flex items-center justify-between pb-2">
                  <h1 className="text-xl font-semibold text-red-900">
                    Statistik Data Perminggu
                  </h1>
                </div>
