...
const EditRegistrationModalAdmin = ({ id, onClose, onUpdate }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setSaving(true);
        try {
            // Use admin endpoint to update all fields
            await put(`registration/update-data/${id}`, {
    ...
    return (
        <ModalContainer 
            ...
            subtitle="Edit informasi registrasi jurusan"
            onClose={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-gray-600">
                <div className="border-b pb-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="mb-4">
                            <label htmlFor="competence_id" className="block mb-2 font-medium text-md">ID Jurusan</label>
                            <input
                                type="text"
                                id="competence_id"
                                name="competence_id"
...
export default EditRegistrationModalAdmin;
