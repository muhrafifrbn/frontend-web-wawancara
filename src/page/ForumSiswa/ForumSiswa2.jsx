...
const ForumSiswa2 = () => {
  ...
  const [dataForm2Siswa, setdataForm2Siswa] = useState(
    state.form2Siswa || {
      skill_competence: "",
      ...
      <div className="max-w-5xl px-4 mx-auto mt-5">
        <div className="flex items-center justify-center text-[12px] w-full font-medium sm:text-sm ">
          <div className="flex items-center justify-center gap-2 px-4 py-2 text-gray-600 border-2 border-gray-300 rounded-full">
            {" "}
            <span className="size-[18px] sm:size-[20px] flex items-center justify-center border-2 rounded-full border-gray-300">
              1
            </span>{" "}
            <span>Data Siswa</span>
          </div>
          <div className="flex w-[10px] sm:w-[40px] bg-gray-300 h-0.5 " />
          <div className="flex items-center justify-center gap-2 px-4 py-2 border-2 rounded-full border-maroon">
            {" "}
            <span className="size-[18px] sm:size-[20px] flex items-center justify-center border-2 rounded-full border-maroon">
              2
            </span>{" "}
            <span>Tentang Sekolah & Prestasi Siswa</span>
          </div>
        ...
        <div className="w-full pb-4 mt-12 border-b-2">
          ...
          <h1 className="mt-1 text-xl font-semibold">
            Tentang Kompetensi Keahlian dan Prestasi
          </h1>
        </div>
            ...
            <div className="">
              ...
              <div className="w-full my-4">
                <label
                  ...
                  className="block mb-2 font-medium text-md e"
                >
                  Apakah Siswa Pernah Memiliki Karya di Kompetensi yang
                  Dipilihnya
                </label>
                <select
            ...
            <div className="flex flex-col justify-between w-full gap-3 mb-4 lg:flex-row">
              <div className="w-full lg:w-[50%] my-4">
                <label
                  ...
                  className="block mb-2 font-medium text-md e"
                >
                  Apakah Pernah Melanggar Tata Tertib Selama Bersekolah di
                  SMP/MTS
                </label>
                <select
              ...
              <div className="w-full lg:w-[50%] my-4">
                <label
                  ...
                  className="block mb-2 font-medium text-md e"
                >
                  Apakah Siswa Siap dan bersedia mengikuti seluruh tata tertib
