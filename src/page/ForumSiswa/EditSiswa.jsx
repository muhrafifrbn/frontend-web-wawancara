    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6 text-gray-600">
        <div className="pb-4 border-b">
          <h3 className="mb-4 text-lg font-semibold">Informasi Siswa</h3>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.religion ? "text-black" : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                <option value="" disabled className="text-gray-400">
                  Pilih Agama
                </option>
                <option value="Islam" className="text-gray-500">
                  Islam
                </option>
                <option value="Katolik" className="text-gray-500">
                  Katolik
                </option>
                <option value="Protestan" className="text-gray-500">
                  Protestan
                </option>
                <option value="Buddha" className="text-gray-500">
                  Buddha
                </option>
                <option value="Hindu" className="text-gray-500">
                  Hindu
                </option>
                <option
                  value="Kepercayaan Kepada Tuhan YME"
        ...
        <div className="pb-4 border-b">
          <h3 className="mb-4 text-lg font-semibold">Informasi Kompetensi</h3>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="mb-4">
              <label
                htmlFor="skill_competence"
                className="block mb-2 font-medium text-md"
              >
                Kompetensi Keahlian
              </label>
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.skill_competence ? "text-black" : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                <option value="" disabled className="text-gray-400">
                  Pilih Jawaban
            ...
            <div className="mb-4">
              <label
                ...
                className="block mb-2 font-medium text-md"
              >
                Apakah Siswa Sudah Tahu Tentang Kompetensi Keahlian yang
                Dipilihnya
              </label>
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.knowledge_about_competence
                    ? "text-black"
                    : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                ...
                <option value="Tahu" className="text-gray-500">
                  Tahu
                </option>
                <option value="Balum Tahu" className="text-gray-500">
                  Belum Tahu
                </option>
              </select>
            </div>
            <div className="mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.has_competence_work ? "text-black" : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                <option value="" disabled className="text-gray-400">
                  Pilih Jawaban
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.active_in_extracurricular
                    ? "text-black"
                    : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.achievements ? "text-black" : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                <option value="" disabled className="text-gray-400">
                  Pilih Jawaban
                </option>
                <option value="Ya" className="text-gray-500">
                  Ya
                </option>
                <option value="Tidak" className="text-gray-500">
                  Belum
                </option>
              </select>
            </div>
            <div className="mb-4">
              <label
                ...
                className="block mb-2 font-medium text-md"
              >
                Apakah Siswa Siap dan bersedia mengikuti seluruh tata tertib di
              ...
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.agree_to_rules ? "text-black" : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                <option value="" disabled className="text-gray-400">
                  Pilih Jawaban
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className={`select-option border-[2px] border-gray-300 h-12 ${
                  formData.ever_broken_rules ? "text-black" : "text-gray-400"
                } text-sm rounded-md focus:ring-maroon outline-none focus:border-maroon block w-full p-2.5`}
              >
                <option value="" disabled className="text-gray-400">
                  Pilih Jawaban
        ...
        <div>
          <h3 className="mb-4 text-lg font-semibold">Informasi Wawancara</h3>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="mb-4">
              <label
